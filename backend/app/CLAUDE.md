...
| `routers/` | 9 APIRouter files — `projects`, `datasets` (upload + list), and `tasks.generate_tasks` are implemented; the rest of `tasks.py` and the other routers remain stubbed with `raise NotImplementedError` |
