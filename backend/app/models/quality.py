...
class ConsensusResult(Base):
    ...
    task: Mapped["Task"] = relationship(back_populates="consensus_results")
...
class ReviewDecision(Base):
    ...
    task: Mapped["Task"] = relationship(back_populates="review_decisions")
    reviewer: Mapped["User"] = relationship(back_populates="review_decisions")
